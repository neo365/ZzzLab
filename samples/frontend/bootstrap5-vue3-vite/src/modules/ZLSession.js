...
ZLSession.install = function (Vue, options) {
    ...
    Vue.config.globalProperties.$session = {
        flash: {
            ...
            get: function (key) {
                ...
                var all_flash = all[ZLSession.flash_key] || {};
            ...
            set: function (key, value) {
                ...
                var all_flash = all[ZLSession.flash_key] || {};
                all_flash[key] = value;
                all[ZLSession.flash_key] = all_flash;
                ZLSession.setAll(all);
            },
        ...
        clear: function () {
            var all = this.getAll();
            ZLSession.setAll({'session-id': all['session-id']});
        },
        destroy: function () {
            ZLSession.setAll({});
        },
