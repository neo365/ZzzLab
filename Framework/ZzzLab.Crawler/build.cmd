...
IF NOT "%2" == "" (
    SET ApiToken=%2
    dotnet nuget push ..\..\Package\ZzzLab.Crawler.%version%.nupkg --api-key %ApiToken% --source https://api.nuget.org/v3/index.json
    start chrome https://www.nuget.org/packages/ZzzLab.Crawler/
)
