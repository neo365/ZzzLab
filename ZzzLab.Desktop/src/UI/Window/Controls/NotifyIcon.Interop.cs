...
namespace System.Windows
{
    public partial class NotifyIcon
    {
        ...
        {
            object? obj = Marshal.PtrToStructure(structPointer, typeof(MouseLLHook));
            if (obj == null) return new Point(0, 0);

            MouseLLHook mouseHook = (MouseLLHook)obj;
            return new Point(mouseHook.X, mouseHook.Y);
        }

        private partial void AttachContextMenu()
        {
            this.ContextMenu.Opened += this.OnContextMenuOpened;
            this.ContextMenu.Closed += this.OnContextMenuClosed;
        }

        private partial void InitializeNativeHooks()
        {
        ...
        {
            _ = UnhookWindowsHookEx(this.mouseHookHandle);
        ...
        private void OnContextMenuOpened(object sender, RoutedEventArgs e)
        {
            ...
            {
                if (module != null && this.hookProcRef != null)
                {
