...
namespace ZzzLab.Data
{
    public static class DBClient
    {
        ...
        public static string CreateConnectionString(DataBaseType serverType, string host, int port, string database, string userid, string password)
        {
            switch (serverType)
            {
                case DataBaseType.PostgreSQL: return PostgreSQLDBHandler.CreateConnectionString(host, port, database, userid, password);
                case DataBaseType.MSSql: return MSSqlDBHandler.CreateConnectionString(host, port, database, userid, password);
                case DataBaseType.Oracle: return OracleDBHandler.CreateConnectionString(host, port, database, userid, password);
